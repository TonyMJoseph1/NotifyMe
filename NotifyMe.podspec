...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
TODO: This CocoaPod provides a button iof its class the ability to notify a user via email he or she entered.
  ...
  s.source           = { :git => 'https://github.com/TonyMJoseph1/NotifyMe.git', :tag => s.version.to_s }
